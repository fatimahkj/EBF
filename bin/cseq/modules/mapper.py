...
class mapper(core.module.BasicModule):
	def init(self):
	...
	def loadfromstring(self, string, env):
		...
		if nodimacs: self.log("reusing DIMACS file [%s]" % outfile)
			...
			self.log("generating DIMACS file")
		...
		test = self.findpropositionalvar_bitwidth(dimacs,'cnondet__3_4__')
		#print("---> %s " % test)

		test = self.findpropositionalvar_bitwidth(dimacs,'bnondet__3_4__')
		#print("---> %s " % test)
