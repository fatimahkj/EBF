...
'''
	...
	- usage with options (need to gather the alternatives from the code below)

	- display backjumps (dotted edges would be nice)

	- handle restarts
	- node (start0) should be at level -1, with (start_i) nodes for the i-th restarts linked to it.
