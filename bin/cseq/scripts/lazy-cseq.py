#!/usr/bin/env python
'''
    CSeq 2.0 wrapper script for Lazy Configuration, SV-COMP 2020
...
svcompparams.append('--backend cbmc --32 --atomic-parameter --cex --deep-propagation --extra-tracking --sv-comp   -l lazy    --rounds=2  --time=200 --depth=1400 --nondet-condvar-wakeups --softunwindbound --unwind-while=1 --unwind-for=1 --unwind-for-max=100')
...
svcompparams.append('--backend cbmc --32 --atomic-parameter --cex --deep-propagation --extra-tracking --sv-comp    -l lazy    --rounds=2  --time=150  --depth=1400  --well-nested-locks                   --unwind-while=2 --unwind-for=2')

svcompparams.append('--backend cbmc --32 --atomic-parameter --cex --deep-propagation --extra-tracking --sv-comp    -l lazy    --rounds=1  --time=60  --depth=400  --well-nested-locks                   --unwind-while=3 --unwind-for=16')
...
svcompparams.append('--backend cbmc --32 --atomic-parameter --cex --deep-propagation --extra-tracking --sv-comp    -l lazy    --rounds=20 --time=250  --depth=750  --well-nested-locks --softunwindbound --unwind-while=1 --unwind-for-max=20 --norobin')
...
svcompparams.append('--backend cbmc --32 --atomic-parameter --cex --deep-propagation --sv-comp    -l lazy    --rounds 4  --time=500 --depth=560  --well-nested-locks --softunwindbound --unwind-while=1 --unwind-for=2 --unwind-for-max=3 --simplify-args')
