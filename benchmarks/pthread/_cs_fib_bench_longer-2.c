/***
 ***  generated by CSeq [ 0000 / 0000 ] 2020-12-23 18:31:38
 ***
 ...
 ***
 ***  params:
 ***    --input /media/sf_esbmc-falsi/sv-benchmarks/c/pthread/fib_bench_longer-2.c -l lazy --sv-comp  --atomic-parameters  --deep-propagation  --rounds 2 --nondet-condvar-wakeups  --unwind-while 2 --unwind-for 2 --witness /media/sf_esbmc-falsi/EnSymfuz_old/Results/witness_File/fib_bench_longer-2.graphml
 ***
 ***  modules:
 ***    7C56 workarounds ()
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {4, 4, 4};
