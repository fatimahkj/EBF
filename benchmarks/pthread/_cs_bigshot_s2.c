/***
 ***  generated by CSeq [ 0000 / 0000 ] 2020-12-23 18:07:58
 ***
 ...
 ***
 ***  params:
 ***    --input /media/sf_esbmc-falsi/sv-benchmarks/c/pthread/bigshot_s2.c -l lazy --sv-comp  --atomic-parameters  --deep-propagation  --rounds 2 --nondet-condvar-wakeups  --unwind-while 2 --unwind-for 2 --witness /media/sf_esbmc-falsi/EnSymfuz_old/Results/witness_File/bigshot_s2.graphml
 ***
 ***  modules:
 ***    7C56 workarounds ()
